...
databag = data_bag_item('page','test')

remote_file "/tmp/#{rpm}" do
  source "https://nginx.org/packages/centos/7/x86_64/RPMS/nginx-#{node['nginx']['version']}-1.el7.ngx.x86_64.rpm"
